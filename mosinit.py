'''
Current clamp demo using Allen Brain's model 329321704.
...
from neuron329321704 import Neuron329321704
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron329321704(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 329321704; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-81.3347930908)
        h.fcurrent()
